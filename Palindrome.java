...
public class Palindrome {
	...
	public static int isPalUtil(int num, int dupNum) throws Exception {
        ...
        if (num % 10 == dupNum % 10) {
            // if first digit values of num and dupNum are equal divide dupNum value by 10 to keep moving in sync with num.
            return dupNum / 10;
        } else {
            // At position values are not matching throw exception and exit, no need to proceed further.
            throw new Exception();
        }
